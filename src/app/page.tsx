...
export default function Home() {
  return (
    <main>
      <Navbar />
      <section className="h-screen w-full bg-neutral-950 rounded-md loverflow-visible relative flex flex-col items-center antialiased">
            ...
            titleComponent={
              <div className="flex items-center flex-col">
                ...
                <h1 className="text-5xl md:text-8xl bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-600 font-sans font-bold">
                  Automate Your Work With Synchro
                </h1>
              </div>
            }
          ></ContainerScroll>
      ...
      <section className="mt-[-500px]">
        ...
        <CardContainer className="inter-var">
          <CardBody className="bg-gray-50 relative group/card dark: hover: shadow-2xl dark:hover:shadow-neutral-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full md:!w-[350px] h-auto rounded-xl p-6 border"></CardBody>
        </CardContainer>
      </section>
    </main>
  );
